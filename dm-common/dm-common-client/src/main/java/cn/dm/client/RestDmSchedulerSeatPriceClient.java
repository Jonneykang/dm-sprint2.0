...
public interface RestDmSchedulerSeatPriceClient {
    ...
    public List<DmSchedulerSeatPrice> getDmSchedulerSeatPriceListByMap(@RequestBody Map<String, Object> param) throws Exception;

    @RequestMapping(value = "/getDmSchedulerSeatPriceCountByMap", method = RequestMethod.POST)
    public Integer getDmSchedulerSeatPriceCountByMap(@RequestBody Map<String, Object> param) throws Exception;
    ...
    public DmSchedulerSeatPrice getDmSchedulerSeatPriceBySchedulerIdAndArea(@RequestParam(value = "areaLevel") Integer areaLevel,
                                                                            @RequestParam(value = "scheduleId") Long scheduleId) throws Exception;
